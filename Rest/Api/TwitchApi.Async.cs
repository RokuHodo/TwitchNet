...
TwitchNet.Rest.Api
{
    ...
    TwitchApi
    {
        ...
        GetUserFollowingPageAsync(string client_id, string from_id, RequestSettings settings = default)
        {
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserFollowingPageAsync(string client_id, string from_id, FollowsParameters parameters, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserFollowingAsync(string client_id, string from_id, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserFollowingAsync(string client_id, string from_id, FollowsParameters parameters, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserFollowersPageAsync(string client_id, string to_id, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserFollowersPageAsync(string client_id, string to_id, FollowsParameters parameters, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserFollowersAsync(string client_id, string to_id, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserFollowersAsync(string client_id, string to_id, FollowsParameters parameters, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        IsUserFollowingAsync(string client_id, string from_id, string to_id, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserRelationshipPageAsync(string client_id, FollowsParameters parameters, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
        ...
        /// <exception cref="RetryLimitReachedException">Thrown if the retry limit was reached.</exception>
        public static async Task<IHelixResponse<FollowsDataPage<Follow>>>
        GetUserRelationshipAsync(string client_id, FollowsParameters parameters, RequestSettings settings = default)
        {
            RestInfo<FollowsDataPage<Follow>> info = new RestInfo<FollowsDataPage<Follow>>(RestClients.Helix, settings);
            info.client_id = client_id;
