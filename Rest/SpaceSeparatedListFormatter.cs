...
{
    /// <summary>
    /// Formats the elements of a collection into a space separated string and added to a <see cref="RestRequest"/> as a single query parameter.
    /// </summary>
    public class SpaceSeparatedListFormatter : QueryParameterFormatter
    {
        /// <summary>
