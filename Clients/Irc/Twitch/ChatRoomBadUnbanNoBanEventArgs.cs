...
{
    public class
    ChatRoomBadUnbanNoBanEventArgs : BadUnbanNoBanEventArgs
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ChatRoomBadUnbanNoBanEventArgs"/> class.
        /// </summary>
        /// <param name="args">The event arguments to parse.</param>
        public ChatRoomBadUnbanNoBanEventArgs(NoticeEventArgs args) : base(args)
        {
