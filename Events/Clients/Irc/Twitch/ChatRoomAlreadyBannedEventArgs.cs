...
{
    public class
    ChatRoomAlreadyBannedEventArgs : AlreadyBannedEventArgs
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="ChatRoomAlreadyBannedEventArgs"/> class.
        /// </summary>
        /// <param name="args">The event arguments to parse.</param>
        public ChatRoomAlreadyBannedEventArgs(ChatRoomNoticeEventArgs args) : base(args)
        {
